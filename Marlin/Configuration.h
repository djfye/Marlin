 ...
 */
#if DISABLED(JUNCTION_DEVIATION) || (ENABLED(DELTA) && ENABLED(JUNCTION_DEVIATION))
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0.375   // Z probe to nozzle Z offset: -below (always!)
